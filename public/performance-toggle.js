// File: public/performance-toggle.js
(function () {
  ...
  function createToggleButton() {
    ...
    if (document.getElementById("performance-toggle")) return;

    var button = document.createElement("button");
    button.id = "performance-toggle";
    button.className =
      "fixed bottom-6 right-6 md:bottom-8 md:left-1/2 md:-translate-x-1/2 z-50 p-3 rounded-full shadow-lg flex items-center gap-2 transition-all duration-300 md:w-auto md:max-w-fit " +
