...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-muted/30 to-background" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold mb-2 inline-block gradient-heading">Get In Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <Card className="shadow-md bg-card dark:bg-dark-100/50 backdrop-blur-sm overflow-hidden h-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-1">fikriprasetya3@gmail.com</p>
                      <a
