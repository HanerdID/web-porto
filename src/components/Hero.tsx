...
export const Hero = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Update CSS variables for the gradient glow effect
      container.style.setProperty("--mouse-x", `${xPercent * 100}%`);
      container.style.setProperty("--mouse-y", `${yPercent * 100}%`);
    };
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-20 left-20 w-64 h-64 bg-theme-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-20 w-72 h-72 bg-accent2/10 rounded-full blur-3xl" />
      </div>
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 py-6 bg-gradient-to-t from-background/80 to-transparent backdrop-blur-sm"
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-8">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">3.73</span> GPA in
              Computer Science
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
